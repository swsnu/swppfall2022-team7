...
export const UPDATE_MEMBER_URL: (projectId: number, userId: number) => string = (projectId: number, userId: number) => `project/detail/${projectId}/member/${userId}/`;
export const UPDATE_PROJECT_URL: (projectId: number) => string = (projectId: number) => `project/detail/${projectId}/m/`;
